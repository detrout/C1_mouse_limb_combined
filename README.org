...
#+BEGIN_SRC python
  ...
  TARGET=os.path.expanduser("~/proj/C1_mouse_limb_combined/paper_analysis_vdir")
  experiment_files = [os.path.expanduser(x.strip()) for x in paper_433_experiment_files.split('\n')]
  experiments = load_experiments(experiment_files)
  library_files = [os.path.expanduser(x.strip()) for x in paper_433_library_files.split('\n')]
